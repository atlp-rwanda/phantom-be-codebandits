                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                       ...
                                       To reset your password, click a button below. If it doesnt work, copy the link to the browser and follow the instructions.
                                        ...
                                        <a href="${data.link}" style="background:#1B73E8;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reset
